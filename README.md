...
> <b><a href="https://tinyurl.com/ingrmrochaCV">My Resume</a></b>

<img src="https://komarev.com/ghpvc/?username=torrober&style=flat&color=blue" alt="Profile views" />
...
#  Projects:
* 🧠 **[Cerebro](https://github.com/openlabun/Cerebro)** - A Sudoku-focused gaming platform built with NestJS, React, React Native, and Docker as a capstone project, featuring authentication, real-time PvP gameplay, leaderboards, a scalable architecture, and cross-platform deployment for web and mobile devices.
...
* 📹 **[Zeus](https://github.com/torrober/Zeus)** - Zoom clone with real-time video calls built with Python, JS, Flask-SocketIO, WebRTC, HTML and CSS
* 🌳 **[ABBGui](https://github.com/torrober/ABBGui)** - Binary Search Tree UI implementation in Java
* 🎵 **[GoMusic](https://github.com/torrober/GoMusic)** - Spotify clone built with JS, jQuery, PHP and the Deezer & YouTube APIs
* 🎲 **[MiParques](https://github.com/torrober/MiParques)** - Colombian board game "Parqués" built with HTML, JS and CSS
